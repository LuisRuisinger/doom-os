...
#define DOOM_OS_DRIVER_DETAIL_CONCAT(lhs__, rhs__)       DOOM_OS_DRIVER_DETAIL_CONCAT_INNER(lhs__, rhs__)
...
#define DOOM_OS_DRIVER_INIT(name__, init_fn__)                                                     \
    static constinit const ::uk::init_record DOOM_OS_DRIVER_DETAIL_CONCAT(__doom_os_driver_init_,  \
                                                                          __COUNTER__)             \
        DOOM_OS_DRIVER_DETAIL_SECTION("doom_os_driver_init") = {&DOOM_OS_DRIVER_DETAIL_ID(name__), \
                                                                init_fn__}
...
#define DOOM_OS_DRIVER_EXIT(name__, exit_fn__)                                                     \
    static constinit const ::uk::exit_record DOOM_OS_DRIVER_DETAIL_CONCAT(__doom_os_driver_exit_,  \
                                                                          __COUNTER__)             \
        DOOM_OS_DRIVER_DETAIL_SECTION("doom_os_driver_exit") = {&DOOM_OS_DRIVER_DETAIL_ID(name__), \
                                                                exit_fn__}

#define DOOM_OS_DRIVER_REQUIRES_DRIVER(name__, dependency__)                         \
    static constinit const ::uk::require_driver_record DOOM_OS_DRIVER_DETAIL_CONCAT( \
        __doom_os_driver_requires_driver_, __COUNTER__)                              \
...
#define DOOM_OS_DRIVER_REQUIRES_CAPABILITY(name__, capability__)                         \
    static constinit const ::uk::require_capability_record DOOM_OS_DRIVER_DETAIL_CONCAT( \
        __doom_os_driver_requires_capability_, __COUNTER__)                              \
        DOOM_OS_DRIVER_DETAIL_SECTION("doom_os_driver_requires_capability") = {          \
            &DOOM_OS_DRIVER_DETAIL_ID(name__), &::uk::capability_key_for<capability__>}
...
#define DOOM_OS_DRIVER_PROVIDES_IMPL(name__, capability__, api_object__, counter__)       \
    ...
    {                                                                                     \
        return static_cast<const void *>(&(api_object__));                                \
                                                                                          ...
                                                                                          \
    static constinit const ::uk::provide_record DOOM_OS_DRIVER_DETAIL_CONCAT(             \
        __doom_os_driver_provides_, counter__)                                            \
        DOOM_OS_DRIVER_DETAIL_SECTION("doom_os_driver_provides") = {                      \
            &DOOM_OS_DRIVER_DETAIL_ID(name__), &::uk::capability_key_for<capability__>,   \
            DOOM_OS_DRIVER_DETAIL_CONCAT(__doom_os_driver_resolve_capability_, counter__)}
