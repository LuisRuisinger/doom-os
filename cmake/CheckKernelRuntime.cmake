...
# An application brings its own C library; a kernel malloc would satisfy its references first.
# dlmalloc is included into kheap.cpp with DLMALLOC_EXPORT static and USE_DL_PREFIX.
if(_symbols MATCHES "[0-9a-fA-F]+ [TtWw] (malloc|free|calloc|realloc|memalign|posix_memalign)\n")
    message(FATAL_ERROR
            ...
            "would allocate from kernel pools with no diagnostic. Check DLMALLOC_EXPORT and "
            "USE_DL_PREFIX in kernel/mm/kheap.cpp.")
endif()
